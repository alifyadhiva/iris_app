...
def iris():
    ...
    st.image("https://www.easytogrowbulbs.com/cdn/shop/products/BeardedIrisColorfullMix_VIS-sqWeb_8a293612-7bc0-4a9f-89ac-917e820d0ccb.jpg?v=1664472481&width=1920", width=400, caption='Iris Flower')
    ...
    if button_var:
        ...
        with st.spinner('Wait for it...'):
            time.sleep(4)
            st.success(f"Prediction of based on your feature input is {output}")
